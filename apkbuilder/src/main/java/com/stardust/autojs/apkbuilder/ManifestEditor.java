...
public class ManifestEditor {
    ...
    private String mHtetzName,mHtetzWhat;
    ...
    public ManifestEditor setHtetzName(String HtetzName,String HtetzWhat) {
        mHtetzName = HtetzName;
        mHtetzWhat = HtetzWhat;
        return this;
    }
    ...
    public void onAttr(AxmlWriter.Attr attr) {
        ...
        if ("value".equals(attr.name.data) && attr.value.toString().contains(mHtetzWhat) && mHtetzName != null && attr.value instanceof StringItem) {
            ((StringItem) attr.value).data = mHtetzName;
            return;
        }
    }
